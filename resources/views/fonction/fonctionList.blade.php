        ...
        <div class="card">
            ...
            <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                    <h4 class="card-title">Liste Fonctions</h4>
                </div>
                <a href="{{route('fonction.view')}}"
                            ...
                            <table id="datatable" class="table table-striped dataTable" data-toggle="data-table"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex align-items-center list-user-action">
                                                ...
                                                <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip"
                                                    ...
                                                    href="{{ route('fonction.edit', $fonction->code) }}"
                                        ...
                                        document.querySelectorAll('.delete-btn').forEach(item => {
                                            item.addEventListener('click', event => {
                                                const fonctionId = event.currentTarget
                                                    .getAttribute('data-id');
                                                const form = document.getElementById(
                                                    'deleteForm');
                                                const actionUrl =
                                                    "{{ route('fonction.destroy', ':id') }}"
                                                    .replace(':id', fonctionId);
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">Echelle</th>
                                        <th scope="col">Structure</th>
                                        <th scope="col">Action</th> <!-- Nouvelle colonne pour les actions -->
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
