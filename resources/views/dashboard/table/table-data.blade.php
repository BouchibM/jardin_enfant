                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-GDM" role="button" aria-expanded="false" aria-controls="sidebar-special">
                            ...
                            <span class="item-name">Dossier Médicale</span>
                            <i class="right-icon">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-GDM" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="../../dashboard/special-pages/billing.html">
                                  <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                  ...
                                  <i class="sidenav-mini-icon"> C </i>
                                  <span class="item-name">Créer  </span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="../../dashboard/special-pages/calender.html">
                                    ...
                                    <i class="sidenav-mini-icon"> LDM </i>
                        ...
                        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="../../dashboard/app/user-profile.html">
                                    ...
                                    <i class="sidenav-mini-icon"> Gc </i>
                                    <span class="item-name">compte</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="../../dashboard/app/user-add.html">
                                    ...
                                    <i class="sidenav-mini-icon"> Gp </i>
                                    <span class="item-name">Poste</span>
                                </a>
                            </li>
