        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('enfant.reafect')}}" role="button" aria-expanded="false"
                            aria-controls="sidebar-special">
                            <i class="icon">
                                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown"
                                    ...
                                    <img src="../../assets/images/avatars/user_Director.png" alt="User-Profile"
                                    ...
                                    <div class="caption ms-3 d-none d-md-block ">
                                        ...
                                        <p class="mb-0 caption-sub-title">Directrice</p>
                                    </div>
                                </a>
