    ...
    <div class="sidebar-body pt-0 data-scrollbar">
      <div class="sidebar-list">
        ...
        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('gestionnaire.inscriptions.index') }}" role="button"
              aria-expanded="false" aria-controls="gpreinscr">
              <i class="icon">
              ...
              <span class="item-name">Gestion Préinscription</span>
            </a>
            <a class="nav-link" href="{{ route('gestionnaire.reinscriptions.index') }}" role="button"
              aria-expanded="false" aria-controls="gpreinscrr">
              <i class="icon">
                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path opacity="0.4"
                    d="M13.3051 5.88243V6.06547C12.8144 6.05584 12.3237 6.05584 11.8331 6.05584V5.89206C11.8331 5.22733 11.2737 4.68784 10.6064 4.68784H9.63482C8.52589 4.68784 7.62305 3.80152 7.62305 2.72254C7.62305 2.32755 7.95671 2 8.35906 2C8.77123 2 9.09508 2.32755 9.09508 2.72254C9.09508 3.01155 9.34042 3.24276 9.63482 3.24276H10.6064C12.0882 3.2524 13.2953 4.43736 13.3051 5.88243Z"
              ...
              <span class="item-name">Gestion Réinscription</span>
            </a>
            <a class="nav-link" href="{{ route('gestionnaire.transfert.index') }}" role="button" aria-expanded="false"
              aria-controls="gptrans">
              <i class="icon">
                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path opacity="0.4"
                    d="M13.3051 5.88243V6.06547C12.8144 6.05584 12.3237 6.05584 11.8331 6.05584V5.89206C11.8331 5.22733 11.2737 4.68784 10.6064 4.68784H9.63482C8.52589 4.68784 7.62305 3.80152 7.62305 2.72254C7.62305 2.32755 7.95671 2 8.35906 2C8.77123 2 9.09508 2.32755 9.09508 2.72254C9.09508 3.01155 9.34042 3.24276 9.63482 3.24276H10.6064C12.0882 3.2524 13.2953 4.43736 13.3051 5.88243Z"
              ...
              <span class="item-name">Gestion Transfert</span>
            </a>
              ...
              <li class="nav-item dropdown">
                <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button"
                  ...
                  <div class="caption ms-3 d-none d-md-block ">
                    <h6 class="mb-0 caption-title">SON</h6>
                    <p class="mb-0 caption-sub-title">gestionnaire</p>
                  </div>
                </a>
...
<style>
  /* Réduire les tailles de police et les paddings pour un affichage moins zoomé */
  .sidebar {
    font-size: 14px;
    ...
    /* Padding réduit */
    height: 100vh;
    /* Hauteur totale de la vue pour éviter l'espace vide en bas */
    overflow-y: auto;
  ...
  .nav-item {
    padding: 5px 15px;
    /* Réduire le padding des items pour moins d'espacement */
  }

  .nav-link {
    padding: 10px;
    /* Padding interne des liens réduit */
  }

  /* Assurer que tous les éléments internes utilisent bien l'espace et ne créent pas de vide inutile */
  .footer {
    padding: 10px 20px;
    /* Ajustement du padding du footer si présent */
    margin-top: auto;
