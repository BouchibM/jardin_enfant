                            ...
                            <table id="datatable" class="table table-striped dataTable" data-toggle="data-table"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">nom</th>
                                        <th scope="col">date_ouverture</th>
                                        <th scope="col">adresse</th>
                                        <th scope="col">num_agrement</th>
                                        <th scope="col">nature_juridique</th>
                                        <th scope="col">poste_amenage</th>
                                ...
                                <tbody>
                                    <tr class="odd">
                                        ...
                                        <td>{{ $jardin->num_agrement }}</td>
                                        <td>{{ $jardin->nature_juridique }}</td>
                                        <td>{{ $jardin->poste_amenage }}</td>
                                        <td>{{ $jardin->capacite }}</td>
                                        <td>@if ($jardin->status == 'ferme')
                                            <span class="badge bg-danger">{{ $jardin->status }}</span>
                                            @else
                                            <span class="badge bg-primary">{{ $jardin->status }}</span>
                                            @endif
                                        </td>
                                        <td>
